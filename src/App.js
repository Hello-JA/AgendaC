...
const data = [ 
  {id: 1, nombre: "Jose Angel", telefono: "70198682"},
  {id: 2, nombre: "Henry Diaz", telefono: "70399743"},
  {id: 3, nombre: "Renato Melo", telefono: "45196725"},
];
      ...
      <>     
        <nav className="navbar navbar-dark bg-primary">
          <div className="container-fluid">
            <div  className="navbar-brand"><img src="https://img.icons8.com/ios/30/000000/anonymous-mask.png"/> Agenda de contactos</div>            
            <form  className="d-flex">
              <input className="form-control me-2" onChange={this.filtrar} type="search" placeholder="Search" aria-label="Search"></input>               
            </form>
            </div>
        </nav>        
        ...
        <Container>             
          ...
          <br />
          <Button color="primary" onClick={()=>this.mostrarModalInsertar()}>Agregar contacto</Button>
          <br />
          <br/> 
        </Container>
        {/* Modal insertar */}
